...
def build_gemini_posture_prompt(
    ...
    return (
        ...
        "Return professional Markdown for a normal gym user, not a technical report. "
        "Use the data to identify repeated movement mistakes, but do not mention angles, degrees, "
